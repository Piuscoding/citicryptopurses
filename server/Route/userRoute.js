...
router.get('/buy-contract',userController.buyPage);
router.post('/buy-contract/:id',userController.buyPage_post);
router.get('/contracts/:id',userController.contractsPage);
