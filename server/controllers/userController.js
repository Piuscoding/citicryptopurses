...
module.exports.aboutPage = (req, res)=>{
   ...
   module.exports.affliatePage = (req, res)=>{
    ...
    module.exports.cryptoPage = (req, res)=>{
      res.render("crypto-trader")
  }
    
    module.exports.startguidePage = (req, res)=>{
        res.render("crypto-trading")
    }
   ...
   module.exports.faqPage = (req, res)=>{
    ...
    module.exports.buyPage = (req, res)=>{
      res.render("buy-contract")
  }

  module.exports.buyPage_post = async(req, res)=>{
  ...
  module.exports.contractsPage = async(req, res)=>{
    try {
      const id = req.params.id
...
module.exports.register_post = async (req, res) =>{
    const {firstname,lastname,username,state,dob,city, email, country, gender,question,answer, password, } = req.body;
    try {
        const user = await User.create({firstname,lastname,username,state,dob,city,question,answer, email, country, gender, password});
